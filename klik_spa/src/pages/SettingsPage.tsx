  ...
  const renderAboutSettings = () => (
    <div className="space-y-6">
      <div className="text-center">
        <img src="/assets/klik_pos/klik_spa/logo.jpeg" alt="R-POS" className="w-16 h-16 mx-auto mb-4 rounded-full object-cover" />
        <h3 className="text-xl font-semibold text-gray-900 dark:text-white">R-POS</h3>
