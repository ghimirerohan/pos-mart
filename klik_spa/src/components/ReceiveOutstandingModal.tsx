                ...
                <>
                    ...
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className="text-xs text-beveren-600 hover:underline"
                        >
                          Split equally
                        </button>
                        <button type="button" onClick={handleAddRow} className="text-xs text-beveren-600 hover:underline">
                          Add row
                        </button>
                      </div>
                    </div>
                  ...
                  <div className="flex gap-2 pt-2">
                    ...
                    <button
                      ...
                      className="flex-1 px-4 py-2 bg-beveren-600 text-white rounded-lg hover:bg-beveren-700 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      Continue
                    </button>
                  </div>
